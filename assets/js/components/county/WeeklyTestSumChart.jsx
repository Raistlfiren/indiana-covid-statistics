...
class WeeklyTestSumChart extends React.Component {
    render() {
        ...
        let series = {
            series: [{
                name: 'Sum of Tests',
                data: this.props.weeklyGroupingSum.map(elem => elem.covidTests)
            }]
        }
                    ...
                    <div className="card overflow-hidden">
                        <div className="card-body">
                            <div className="d-flex justify-content-between align-items-baseline mb-4 mb-md-3">
                                <h6 className="card-title mb-0">Weekly Test SUM</h6>
                            ...
                            <div className="row align-items-start mb-2">
                                <div className="col-md-12">
                                    <p className="text-muted tx-13 mb-3 mb-md-0">
                                        This is an overlook of the weekly test SUM over time.
                                    </p>
                                </div>
                            </div>
...
export default WeeklyTestSumChart;