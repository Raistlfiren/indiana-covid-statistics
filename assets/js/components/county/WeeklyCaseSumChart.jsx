...
class WeeklyCaseSumChart extends React.Component {
    render() {
        ...
        let series = {
            series: [{
                name: 'Sum of Cases',
                data: this.props.weeklyGroupingSum.map(elem => elem.covidCount)
            }]
        }
                    ...
                    <div className="card overflow-hidden">
                        <div className="card-body">
                            <div className="d-flex justify-content-between align-items-baseline mb-4 mb-md-3">
                                <h6 className="card-title mb-0">Weekly Case SUM</h6>
...
export default WeeklyCaseSumChart;