...
class NewTestsSparkline extends React.Component {
    render() {
        const series = {
            series: [{
                data: this.props.dailyCovidTests.slice(-7)
            }]
        }
                ...
                <div className="card">
                    <div className="card-body">
                        <div className="d-flex justify-content-between align-items-baseline">
                            <h6 className="card-title mb-0">New Tests</h6>
...
export default NewTestsSparkline;