...
class BigCaseChart extends React.Component {
    render() {
        ...
        let series = {
            series: [
                {
                    name: 'Cases',
                    data: this.props.dailyCovidCount
                },
                {
                    name: '7 Day Moving Average',
                    data: this.props.dailyCovidCountSMA
                },
                {
                    name: '14 Day Moving Average',
                    data: this.props.padArrayLeft(sma(this.props.dailyCovidCount, 14, this.toFixed), totalCount, 0),
                }
            ],
        }
                    ...
                    <div className="card overflow-hidden">
                        <div className="card-body">
                            <div className="d-flex justify-content-between align-items-baseline mb-4 mb-md-3">
                                <h6 className="card-title mb-0">Cases</h6>
